...
volatile int clock_hours, clock_mins, clock_seconds = 0;
...
void loop(){
  int currentSecond = clock_seconds;
  delay(100);
  int newSecond = clock_seconds;
  if(currentSecond != newSecond){ //detect a change in seconds and print the time 
    printTime();  
  }
}
